    ...
    function TimePicker(props) {
        ...
        _this.renderTimePicker = function (locale) {
            ...
            var inputIcon = React.createElement(
                ...
                React.createElement(_icon2['default'], { type: 'clock-circle-o', className: props.prefixCls + '-clock-icon' })
            );
            var clearIcon = React.createElement(_icon2['default'], { type: 'close-circle', className: props.prefixCls + '-panel-clear-btn-icon' });
